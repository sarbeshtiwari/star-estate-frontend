    ...
    <div className="w-100 padding">
        <div className="container-lg">
            ...
            <h6 className="form--title">Realty Check - A Must Read Before Investing in Real Estate</h6>
                    <p className="mb-4">Realty Check is an insight into the real estate market with reputed developers and RERAregistered projects. Via the process, investors inch closer to properties that hold the potential
